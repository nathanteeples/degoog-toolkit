...
//
// Trigger choice:
// This Store plugin owns `speedtest` when the deployment's built-in command is
// disabled. Keep `speed` as the guaranteed fallback alias if a future degoog
// release restores or prioritizes the built-in command.
//
// Natural language:
